...
class TestEMRExecutorTask(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.dag.context['dag_run'].conf = {'first_param': 'hi'}
    ...
    def test_apply_task_to_dag(self):
        self.emr.apply_task_to_dag(task=self.hadoop_task, parent=None)
    ...
    def test_add_step(self, mock_emr_hook_get_conn):
        ...
        self.assertEqual(desc_step['Config'],
                         {'Jar': 'command-runner.jar',
                          'Properties': {},
                          'Args': ['spark-submit', 'test', 'params', '--hi']
                          })
