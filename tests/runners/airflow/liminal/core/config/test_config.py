...
class TestHierarchicalConfig(TestCase):
    ...
    def test_safe_load(self, find_config_files_mock):
        ...
        expected = [{'name': 'my_subliminal_test',
                     ...
                     'services': [],
                     'super': 'my_superliminal_test',
                     'task_defaults': {'job_end': {'task_sub_def': 'task_sub_def_value'},
                                       'job_start': {'task_sub_def': 'task_sub_def_value'}},
                     'type': 'sub'}]
        ...
        self.assertEqual(expected, config_util.safe_load())
    ...
    def test_merge_superliminals(self, find_config_files_mock):
        ...
        self.assertEqual(expected, config_util._ConfigUtil__merge_superliminals(superliminal, super_superliminal))
        ...
        expected = [{'name': 'my_subliminal_test',
                     ...
                     'services': [{'description': 'add defaults parameters for all services',
                                  ...
                                  {'description': 'add defaults parameters for all services',
                                   ...
                                   'type': 'python_server'}],
                     'super': 'my_superliminal_test',
                     'task_defaults': {'task_sub_def': 'task_sub_def_value'},
                     'type': 'sub',
                     'variables': {'image': 'prod image',
                                   'var': 'simple case',
                                   'var-2': '-case',
                                   'var_2': '_case'}}]
